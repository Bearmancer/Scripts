...
public class VisibilityTests
{
    ...
    {
        var type = typeof(ScriptsDbContext).Assembly.GetType("Scripts.Data.TextNormalizer");
    ...
    {
        var assembly = typeof(Scripts.CLI.Program).Assembly;
        var type = assembly.GetType("Scripts.CLI.ServiceRegistration");
