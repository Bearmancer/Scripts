...
namespace Scripts.Migrations
{
	...
	{
		private static readonly string[] columns = new[] { "ArtistId", "Title" };

		protected override void Up(MigrationBuilder migrationBuilder)
		{
			migrationBuilder.EnsureSchema(name: "music");

			migrationBuilder.EnsureSchema(name: "fibery");

			migrationBuilder.EnsureSchema(name: "youtube");
			...
			migrationBuilder.CreateTable(
				...
				constraints: table => table.PrimaryKey("PK_execution_logs", x => x.Id));
			...
			migrationBuilder.CreateTable(
				...
				constraints: table => table.PrimaryKey("PK_fibery_entities", x => x.Id));
			...
			migrationBuilder.CreateTable(
				...
				constraints: table => table.PrimaryKey("PK_source_records", x => x.Id));
		...
		{
			migrationBuilder.DropTable(name: "failed_tasks");

			migrationBuilder.DropTable(name: "fibery_entities", schema: "fibery");

			migrationBuilder.DropTable(name: "release_progress", schema: "music");

			migrationBuilder.DropTable(name: "scrobbles", schema: "music");

			migrationBuilder.DropTable(name: "source_records");

			migrationBuilder.DropTable(name: "videos", schema: "youtube");

			migrationBuilder.DropTable(name: "execution_logs");

			migrationBuilder.DropTable(name: "tracks", schema: "music");

			migrationBuilder.DropTable(name: "albums", schema: "music");

			migrationBuilder.DropTable(name: "artists", schema: "music");
		}
	}
}
