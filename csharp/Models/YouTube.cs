...
internal record YouTubePlaylist(
    string Id,
    string Title,
    int VideoCount,
...
internal record PlaylistSnapshot(
    string PlaylistId,
    string Title,
    List<string> VideoIds,
...
internal record YouTubeFetchState
{
...
internal record PlaylistRename(string PlaylistId, string OldTitle, string NewTitle);

internal record PlaylistChanges(
...
internal record OptimizedChanges(
    List<string> NewIds,
