    ...
    public partial class ScrobbleEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            var index2 = runtimeEntityType.AddIndex(
                new[] { platform, scrobbledAt });
            index2.AddAnnotation("Relational:Name", "idx_scrobbles_platform_scrobbled_at");

            var index3 = runtimeEntityType.AddIndex(
                new[] { trackId, scrobbledAt },
                unique: true);
            index3.AddAnnotation("Relational:Name", "idx_scrobbles_timestamp");
