...
`github.copilot.chat.agentDebugLog.fileLogging.enabled: true` causes the agent to write span data to a file literally
named "NUL" instead of a proper log filename.
