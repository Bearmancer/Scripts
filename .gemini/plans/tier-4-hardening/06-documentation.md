...
**Goal:** Verify `GEMINI.md` is accurate and complete, mark all completed plan phases `✅` in `INDEX.md`, and ensure `README.md` has a working quick-start section covering Docker, env vars, build, and test.
...
$docs = @(
    'C:\Users\Lance\Dev\Scripts\GEMINI.md',
...
public class DocStructureTests
{
    ...
    [Test]
    public void GeminiMd_Exists_AtRepoRoot()
    {
        File.Exists(@"C:\Users\Lance\Dev\Scripts\GEMINI.md")
            .Should().BeTrue("GEMINI.md must exist at repo root");
    }

    [Test]
    public void GeminiMd_Contains_ProjectOverviewSection()
    {
        var content = File.ReadAllText(@"C:\Users\Lance\Dev\Scripts\GEMINI.md");
        content.Should().Contain("## 1. Project Overview");
    }

    [Test]
    public void GeminiMd_Contains_EnvironmentSetupSection()
    {
        var content = File.ReadAllText(@"C:\Users\Lance\Dev\Scripts\GEMINI.md");
    ...
    [Test]
    public void GeminiMd_Contains_AbsoluteZeroRulesetSection()
    {
        var content = File.ReadAllText(@"C:\Users\Lance\Dev\Scripts\GEMINI.md");
    ...
    [Test]
    public void GeminiMd_Contains_PlanNavigationSection()
    {
        var content = File.ReadAllText(@"C:\Users\Lance\Dev\Scripts\GEMINI.md");
    ...
    [Test]
    public void GeminiMd_Mentions_Tier4Hardening()
    {
        var content = File.ReadAllText(@"C:\Users\Lance\Dev\Scripts\GEMINI.md");
        content.Should().Contain("tier-4-hardening",
            "GEMINI.md plan navigation must reference tier-4-hardening");
    }

    // ── INDEX.md ───────────────────────────────────────────────────────────

    [Test]
    public void IndexMd_Exists_InGeminiPlans()
    {
        File.Exists(@"C:\Users\Lance\Dev\Scripts\.gemini\plans\INDEX.md")
            .Should().BeTrue("INDEX.md must exist in .gemini/plans/");
    }

    [Test]
    public void IndexMd_HasAllFourTiers()
    {
        var content = File.ReadAllText(@"C:\Users\Lance\Dev\Scripts\.gemini\plans\INDEX.md");
    ...
    public void IndexMd_Tier4_HasAllEightPhases()
    {
        ...
        content.Should().Contain("07-sign-off.md");
    }
...
```powershell
$indexPath = 'C:\Users\Lance\Dev\Scripts\.gemini\plans\INDEX.md'
...
| [07-sign-off.md](...)           | Release-ready ...         | ✅ |
```

Also update the Tier Overview table row for T4 from `🔒 T3` to `✅ Done`:

```markdown
| T4   | `tier-4-hardening/`         | 00–07  | DI, integration, quality, tooling, security        | ✅ Done |
```

- [ ] **Step 3: Read-back — verify changes**

```powershell
$content = Get-Content 'C:\Users\Lance\Dev\Scripts\.gemini\plans\INDEX.md' -Raw -Encoding UTF8
...
## Task 3: Verify and update GEMINI.md

- [ ] **Step 1: Check GEMINI.md plan navigation references Tier 4**

```powershell
$gemini = Get-Content 'C:\Users\Lance\Dev\Scripts\GEMINI.md' -Raw -Encoding UTF8
if ($gemini -notmatch 'tier-4-hardening') {
    Write-Warning "GEMINI.md plan navigation missing tier-4-hardening reference"
}
```

- [ ] **Step 2: Update GEMINI.md Plan Navigation block (if stale)**

In `GEMINI.md` section `## 10. Plan Navigation`, verify this block exists:
...
git -C C:\Users\Lance\Dev\Scripts add `
    GEMINI.md `
    README.md `
    .gemini/plans/INDEX.md `
    csharp/tests/Scripts.Tests/DocumentationTests/
git -C C:\Users\Lance\Dev\Scripts commit -m "feat(t4-06): final docs pass — INDEX.md T4 complete, README quick-start, GEMINI.md verified"
```
...
- [ ] `GEMINI.md` contains all 10 required sections
- [ ] `GEMINI.md` references `tier-4-hardening` in plan navigation
