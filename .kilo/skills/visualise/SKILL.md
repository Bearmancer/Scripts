...
2. **Then read the relevant module**:
   ...
   - Structural Knowledge Mapping (Book/Java graphs): `references/graph-architect.md`
...
| "show me the graph of X"       | Structural Knowledge  | Node-link graph (Graph Architect)      |
